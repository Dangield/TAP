...
subplot(2, 1, 1)
stairs(u(1, :), 'r');
title('C_{Ain}, Zak≥Ûcenie T_{in}=325, model nieliniowy')

subplot(2, 1, 2)
stairs(u(2, :), 'r');
title('F_{C}, Zak≥Ûcenie T_{in}=325, model nieliniowy')
...
stairs(setY(1, :), 'b');
stairs(y(1, :), 'r');
title('C_A, Zak≥Ûcenie T_{in}=325, model nieliniowy')

subplot(2, 1, 2);
hold on;
stairs(setY(2, :), 'b');
stairs(y(2, :), 'r');
title('T, Zak≥Ûcenie T_{in}=325, model nieliniowy')
...
subplot(2, 1, 1)
stairs(u(1, :), 'r');
title('C_{Ain}, Zak≥Ûcenie T_{in}=343, model nieliniowy')

subplot(2, 1, 2)
stairs(u(2, :), 'r');
title('F_{C}, Zak≥Ûcenie T_{in}=343, model nieliniowy')
...
stairs(setY(1, :), 'b');
stairs(y(1, :), 'r');
title('C_A, Zak≥Ûcenie T_{in}=343, model nieliniowy')

subplot(2, 1, 2);
hold on;
stairs(setY(2, :), 'b');
stairs(y(2, :), 'r');
title('T, Zak≥Ûcenie T_{in}=343, model nieliniowy')
...
subplot(2, 1, 1)
stairs(u(1, :), 'r');
title('C_{Ain}, Zak≥Ûcenie T_Cin=367, model nieliniowy')

subplot(2, 1, 2)
stairs(u(2, :), 'r');
title('F_{C}, Zak≥Ûcenie T_Cin=367, model nieliniowy')
...
stairs(setY(1, :), 'b');
stairs(y(1, :), 'r');
title('C_A, Zak≥Ûcenie T_Cin=367, model nieliniowy')

subplot(2, 1, 2);
hold on;
stairs(setY(2, :), 'b');
stairs(y(2, :), 'r');
title('T, Zak≥Ûcenie T_Cin=367, model nieliniowy')
...
subplot(2, 1, 1)
stairs(u(1, :), 'r');
title('C_{Ain}, Zak≥Ûcenie T_Cin=385, model nieliniowy')

subplot(2, 1, 2)
stairs(u(2, :), 'r');
title('F_{C}, Zak≥Ûcenie T_Cin=385, model nieliniowy')
...
stairs(setY(1, :), 'b');
stairs(y(1, :), 'r');
title('C_A, Zak≥Ûcenie T_Cin=385, model nieliniowy')

subplot(2, 1, 2);
hold on;
stairs(setY(2, :), 'b');
stairs(y(2, :), 'r');
title('T, Zak≥Ûcenie T_Cin=385, model nieliniowy')